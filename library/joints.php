...
function joints_scripts_and_styles() {
	...
	if ( ! is_admin() ) {
		...
		wp_enqueue_style( 'googlefonts-opensans', '//fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,700italic,400,300,700', array(), '1.0.0', false );
